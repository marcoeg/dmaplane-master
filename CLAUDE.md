...
### Ioctl numbering
- Magic: `0xE4`
- Groups: buffer management `0x01`–`0x09`, RDMA `0x10`–`0x19`, MR `0x20`–`0x29`, benchmarks `0x30`–`0x39`, flow control `0x40`–`0x43`, NUMA `0x50`–`0x59`, GPU P2P `0x60`–`0x67`, histogram `0x70`, WRITEIMM `0x80`–`0x82`, peer RDMA `0x90`–`0x94`
